      ...
      <div v-for="fav in favorites" :key="fav.id" class="glass-card">
        ...
        <template v-if="getEnrolledRelation(fav.courseId)">
          ...
          <div class="actions">
            ...
            <div class="btn-row">
              <button class="btn btn-learn" @click="router.push('/course/' + fav.courseId)">
...
.btn-learn {
  flex: 1; background: rgba(29,29,31,0.72); backdrop-filter: blur(12px); color: #fff;
  border: none; box-shadow: 0 2px 8px rgba(0,0,0,0.15);
}
.btn-learn:hover { background: rgba(0,0,0,0.82); transform: translateY(-1px); box-shadow: 0 4px 16px rgba(0,0,0,0.22); }
.btn-detail {
